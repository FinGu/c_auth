...
class c_functions {
	...
	public static function display_user_data($username, $is_premium) : void {
	    ?><ul class="dt-nav"><li class="dt-nav__item dropdown"><a href="#" class="dt-nav__link dropdown-toggle no-arrow dt-avatar-wrapper" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="dt-avatar size-30" src="../assets/images/user-avatar/default.png" alt="default"><span class="dt-avatar-info d-none d-sm-block"><span class="dt-avatar-name"><?php echo self::xss_clean($username); ?></span></span> </a><div class="dropdown-menu dropdown-menu-right"><div class="dt-avatar-wrapper flex-nowrap p-6 mt-n2 bg-gradient-purple text-white rounded-top"><img class="dt-avatar" src="../assets/images/user-avatar/default.png" alt="default"><span class="dt-avatar-info"><span class="dt-avatar-name"><?php echo $username; ?></span><span class="f-12"><?php echo ($is_premium) ? 'Premium User' : 'Free User'; ?></span></span></div><a class="dropdown-item" href="account.php"><i class="icon icon-user icon-fw mr-2 mr-sm-1"></i>Account</a><a class="dropdown-item" href="logout.php"><i class="icon icon-editors icon-fw mr-2 mr-sm-1"></i>Logout</a></div></li></ul><?php
    }
